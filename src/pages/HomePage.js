            ...
            <Jumbotron fluid>
                <Container>
                    ...
                    <p className="jumboText">
                       ...
                       We are working to make this website the best it can be for our users to access good and useful tutorials, guides and news about coding related languages. 
                    </p>
                </Container>
            </Jumbotron>
